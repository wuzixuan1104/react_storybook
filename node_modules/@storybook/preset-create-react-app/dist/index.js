...
exports.webpack = exports.managerWebpack = void 0;
...
exports.webpack = function (webpackConfig, options) {
    ...
    var typescriptOptions = options.typescriptOptions;
    var tsDocgenRule = !typescriptOptions ||
                ...
                use: [
                    {
                        ...
                        options: typescriptOptions === null || typescriptOptions === void 0 ? void 0 : typescriptOptions.reactDocgenTypescriptOptions,
                    },
                ],
            },
        ]
    ...
    return __assign(__assign({}, webpackConfig), { module: __assign(__assign({}, webpackConfig.module), { rules: __spread((filteredRules || []), craRules, tsDocgenRule) }), plugins: mergePlugins_1.mergePlugins(webpackConfig.plugins, craWebpackConfig.plugins), resolve: __assign(__assign({}, webpackConfig.resolve), { extensions: craWebpackConfig.resolve.extensions, modules: __spread(((webpackConfig.resolve && webpackConfig.resolve.modules) || []), [
