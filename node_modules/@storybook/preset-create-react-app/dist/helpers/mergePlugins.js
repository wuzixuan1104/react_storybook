...
exports.mergePlugins = function (basePlugins, additionalPlugins) {
    if (basePlugins === void 0) { basePlugins = []; }
    if (additionalPlugins === void 0) { additionalPlugins = []; }
    return __spread(basePlugins, additionalPlugins).reduce(function (plugins, plugin) {
